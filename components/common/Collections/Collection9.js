...
const ProductSlider = ({ type }) => {
  ...
  return (
    <Fragment>
      <section
        className={`${
          type !== "fashion" && type !== "kids" ? "section-b-space" : ""
        }`}
      >
        <Container>
            ...
            <Col lg="3" sm="6">
              <div className="theme-card">
                ...
                <Slider className="offer-slider slide-1">
                  <div>
                    {data &&
                      data.products.items.slice(0, 3).map((product, index) => (
                  ...
                  <div>
                    {data &&
                      data.products.items.slice(4, 7).map((product, index) => (
                        <div className="media" key={index}>
                          <a onClick={() => clickProductDetail(product)}>
                            <Media
                              className="img-fluid blur-up lazyload"
            ...
            <Col lg="3" sm="6">
              <div className="theme-card">
                ...
                <Slider className="offer-slider slide-1">
                  <div>
                    {data &&
                      data.products.items.slice(7, 10).map((product, index) => (
                        <div className="media" key={index}>
                          <a onClick={() => clickProductDetail(product)}>
                            <Media
                              className="img-fluid blur-up lazyload"
